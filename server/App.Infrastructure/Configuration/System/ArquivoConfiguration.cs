...
namespace App.Infrastructure.Configuration.System;
...
public class ArquivoConfiguration : IEntityTypeConfiguration<Arquivo>
{
    ...
    {
        // Adicione aqui relacionamentos com entidades de domínio quando necessário
        // Exemplo: builder.HasMany(a => a.MinhasEntidades).WithOne(e => e.Arquivo).HasForeignKey(e => e.ArquivoId);
