import{Db as j,J as N,K as L,Ma as R,Na as C,Pa as $,Sa as Q,Wa as lt,Ya as at,cb as rt,f as A,j as z,xb as st}from"./chunk-SPPQJ6WL.js";import{$b as nt,Bc as E,Db as w,Eb as tt,Ic as s,Jb as F,Jc as V,Lb as r,Ma as u,Ob as d,Qb as c,R as B,Rb as g,S as O,T as P,X as M,Za as S,Zb as p,_a as H,_b as et,aa as U,ba as Y,bb as D,cb as J,db as m,fb as x,fc as I,hc as q,ic as ot,nb as h,oa as f,ob as y,pb as _,sb as W,sc as it,tb as X,ub as v,vb as T,wb as k,xb as Z}from"./chunk-62PX7AXF.js";var ut=`
    .p-togglebutton {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
...
`,Et={root:({instance:e})=>["p-togglebutton p-component",{"p-togglebutton-checked":e.checked,"p-invalid":e.invalid(),"p-disabled":e.$disabled(),"p-togglebutton-sm p-inputfield-sm":e.size==="small","p-togglebutton-lg p-inputfield-lg":e.size==="large","p-togglebutton-fluid":e.fluid()}],content:"p-togglebutton-content",icon:"p-togglebutton-icon",iconLeft:"p-togglebutton-icon-left",iconRight:"p-togglebutton-icon-right",label:"p-togglebutton-label"},dt=(()=>{class e extends ${name="togglebutton";theme=wt;classes=Et;static \u0275fac=(()=>{let t;return function(o){return(t||(t=f(e)))(o||e)}})();static \u0275prov=O({token:e,factory:e.\u0275fac})}return e})();var Lt={provide:Q,useExisting:B(()=>G),multi:!0},G=(()=>{class e extends j{onKeyDown(t){switch(t.code){case"Enter":this.toggle(t),t.preventDefault();break;case"Space":this.toggle(t),t.preventDefault();break}}toggle(t){!this.$disabled()&&!(this.allowEmpty===!1&&this.checked)&&(this.checked=!this.checked,this.writeModelValue(this.checked),this.onModelChange(this.checked),this.onModelTouched(),this.onChange.emit({originalEvent:t,checked:this.checked}),this.cd.markForCheck())}onLabel="Yes";offLabel="No";onIcon;offIcon;ariaLabel;ariaLabelledBy;styleClass;inputId;tabindex=0;iconPos="left";autofocus;size;allowEmpty;fluid=E(void 0,{transform:s});onChange=new x;iconTemplate;contentTemplate;templates;checked=!1;_componentStyle=M(dt);onBlur(){this.onModelTouched()}get hasOnLabel(){return this.onLabel&&this.onLabel.length>0}get hasOffLabel(){return this.onLabel&&this.onLabel.length>0}get active(){return this.checked===!0}_iconTemplate;_contentTemplate;ngAfterContentInit(){this.templates.forEach(t=>{switch(t.getType()){case"icon":this._iconTemplate=t.template;break;case"content":this._contentTemplate=t.template;break;default:this._contentTemplate=t.template;break}})}writeControlValue(t,n){this.checked=t,n(t),this.cd.markForCheck()}static \u0275fac=(()=>{let t;return function(o){return(t||(t=f(e)))(o||e)}})();static \u0275cmp=S({type:e,selectors:[["p-toggleButton"],["p-togglebutton"],["p-toggle-button"]],contentQueries:function(n,o,i){if(n&1&&(d(i,ht,4),d(i,yt,4),d(i,R,4)),n&2){let l;c(l=g())&&(o.iconTemplate=l.first),c(l=g())&&(o.contentTemplate=l.first),c(l=g())&&(o.templates=l)}},hostVars:6,hostBindings:function(n,o){n&1&&F("keydown",function(l){return o.onKeyDown(l)})("click",function(l){return o.toggle(l)}),n&2&&(h("aria-labelledby",o.ariaLabelledBy)("aria-pressed",o.checked)("role","button")("tabindex",o.$disabled()?-1:0),p(o.cn(o.cx("root"),o.styleClass)))},inputs:{onLabel:"onLabel",offLabel:"offLabel",onIcon:"onIcon",offIcon:"offIcon",ariaLabel:"ariaLabel",ariaLabelledBy:"ariaLabelledBy",styleClass:"styleClass",inputId:"inputId",tabindex:[2,"tabindex","tabindex",V],iconPos:"iconPos",autofocus:[2,"autofocus","autofocus",s],size:"size",allowEmpty:"allowEmpty",fluid:[1,"fluid"]},outputs:{onChange:"onChange"},features:[I([Lt,dt]),J([st]),D],decls:3,vars:7,consts:[[4,"ngTemplateOutlet","ngTemplateOutletContext"],[3,"class"]],template:function(n,o){n&1&&(T(0,"span"),m(1,_t,1,0,"ng-container",0),y(2,kt,4,5),k()),n&2&&(p(o.cx("content")),u(),v("ngTemplateOutlet",o.contentTemplate||o._contentTemplate)("ngTemplateOutletContext",q(5,ct,o.checked)),u(),_(o.contentTemplate?-1:2))},dependencies:[z,A,C],encapsulation:2,changeDetection:0})}return e})();var gt=`
    .p-selectbutton {
        display: inline-flex;
        user-select: none;
